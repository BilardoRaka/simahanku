                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Buat Bahan Baku</h3>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    @method('POST')
                        ...
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control form-control-lg form-control-outlined @error('unit') is-invalid @enderror" id="unit" name="unit">
